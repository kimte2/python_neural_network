...
#プロットの表示
plt.scatter(position_tokyo[0], position_tokyo[1], c="red", label="Tokyo", market="+")
plt.scatter(position_kanagawa[0], position_kanagawa[1], c="blue", label="Kanagawa", market="+")
